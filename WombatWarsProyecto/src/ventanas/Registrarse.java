...
import utilidadesUsuario.UsuarioRepetido;
import utilidadesUsuario.UtilidadesLogin;
		...
		btnRegistrarNuevoUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (!textField.getText().equals("") && !textField_1.getText().equals("")) {
					...
					GeneracionLogger.log.info("INFO: Se ha registrado un nuevo usuario");
					...
					Registrarse.this.dispose();
						...
						GeneracionLogger.log.error("ERROR: El usuario ha intentado registrar un usuario que ya existe.");

					}

				} else {
					JOptionPane.showMessageDialog(Registrarse.this, "Por favor, rellene todos los campos");
					GeneracionLogger.log.error("ERROR: El usuario no ha rellenado todos los campos del registro.");
				}
			}
		});
